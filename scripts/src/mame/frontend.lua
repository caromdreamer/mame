...
files {
	...
	MAME_DIR .. "src/frontend/mame/kaileron_frame_runner.cpp",
	MAME_DIR .. "src/frontend/mame/kaileron_frame_runner.h",
	MAME_DIR .. "src/frontend/mame/kaileron_state_store.cpp",
	MAME_DIR .. "src/frontend/mame/kaileron_state_store.h",
